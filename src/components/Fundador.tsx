    ...
    <section id="sobre" className="relative py-14 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        <div className="mb-8">
          ...
          >
            {m.fundador.titleBefore}{" "}
            <span className="text-cyan text-glow">{m.fundador.titleAccent}</span>
          </h2>
        </div>
          ...
          <div>
            ...
            <div className="mb-8">
              <p className="font-display font-semibold text-xs uppercase tracking-widest text-slate-500 mb-4">
                {m.fundador.skillsHeading}
              </p>
              <div className="flex flex-wrap gap-2">
                {m.fundador.skills.map((skill) => (
                  <span
                    key={skill}
            ...
            <div className="flex gap-3">
              ...
              >
                <Linkedin size={14} /> {m.fundador.linkedin}
              </a>
              <a
                ...
                className="inline-flex items-center gap-2 border border-slate-700 text-slate-400 hover:border-cyan/50 hover:text-cyan font-display text-xs uppercase tracking-wider px-4 py-2.5 rounded transition-all duration-300"
              >
                <Github size={14} /> {m.fundador.github}
              </a>
            </div>
          </div>
        </div>
